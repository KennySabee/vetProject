  ...
  return (
    <div className="mx-5 my-10 bg-white shadow-md px-5 py-10 rounded-xl">
      ...
      <div className="flex justify-between mt-10">
        <button
          type="button"
          className=" py-2 px-10 bg-indigo-600 text-white rounded-md font-bold uppercase hover:bg-indigo-700  "
        ...
        <button
          type="button"
          className=" py-2 px-10 bg-red-700 text-white rounded-md font-bold uppercase hover:bg-red-600 "
